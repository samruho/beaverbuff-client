      ...
      <div className="suv">
        <div className="inner" style={{ padding: '6rem 0' }}>
          <h2 style={{ fontSize: '3em' }}>
            <EditableText contentKey="suv.title" defaultValue="SUV Services" />
          </h2>
          ...
          <div style={{ display: 'flex', gap: '6rem' }}>
            ...
            <div style={{ flex: '1 1 33%' }}>
              <EditableImage
                contentKey="suv.interior.image"
                defaultValue="/images/interior.jpg"
                alt="Interior Detailing"
                style={{ width: '100%' }}
              />
              <h3>
                <EditableText contentKey="suv.interior.heading" defaultValue="Interior Detailing" />
              </h3>
              <p>
                <EditableText
                  contentKey="suv.interior.body"
            ...
            <div style={{ flex: '1 1 33%' }}>
              <EditableImage
                contentKey="suv.exterior.image"
                defaultValue="/images/exterior.jpg"
                alt="Exterior Detailing"
                style={{ width: '100%' }}
              />
              <h3>
                <EditableText contentKey="suv.exterior.heading" defaultValue="Exterior Detailing" />
              </h3>
              <p>
                <EditableText
                  contentKey="suv.exterior.body"
            ...
            <div style={{ flex: '1 1 33%' }}>
              <EditableImage
                contentKey="suv.paint.image"
                defaultValue="/images/engine.jpg"
                alt="Paint Correction"
                style={{ width: '100%' }}
              />
              <h3>
                <EditableText contentKey="suv.paint.heading" defaultValue="Paint Correction and Coating" />
              </h3>
              <p>
                <EditableText
                  contentKey="suv.paint.body"
