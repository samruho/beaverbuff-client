...
const Sedan: React.FC = () => {
  return (
    <>
      <div className="sedan">
        <div className="inner" style={{ padding: '6rem 0' }}>
          <h2 style={{ fontSize: '3em' }}>
            <EditableText contentKey="sedan.title" defaultValue="Sedan Services" />
          </h2>
          ...
          <div style={{ display: 'flex', gap: '6rem' }}>
            ...
            <div style={{ flex: '1 1 33%' }}>
              <EditableImage
                contentKey="sedan.interior.image"
                defaultValue="/images/interior.jpg"
                alt="Interior Detailing"
                style={{ width: '100%' }}
              />
              <h3>
                <EditableText contentKey="sedan.interior.heading" defaultValue="Interior Detailing" />
              </h3>
              <p>
                <EditableText
                  contentKey="sedan.interior.body"
            ...
            <div style={{ flex: '1 1 33%' }}>
              <EditableImage
                contentKey="sedan.exterior.image"
                defaultValue="/images/exterior.jpg"
                alt="Exterior Detailing"
                style={{ width: '100%' }}
              />
              <h3>
                <EditableText contentKey="sedan.exterior.heading" defaultValue="Exterior Detailing" />
              </h3>
              <p>
                <EditableText
                  contentKey="sedan.exterior.body"
            ...
            <div style={{ flex: '1 1 33%' }}>
              <EditableImage
                contentKey="sedan.paint.image"
                defaultValue="/images/engine.jpg"
                alt="Paint Correction"
                style={{ width: '100%' }}
              />
              <h3>
                <EditableText contentKey="sedan.paint.heading" defaultValue="Paint Correction and Coating" />
              </h3>
              <p>
                <EditableText
                  contentKey="sedan.paint.body"
